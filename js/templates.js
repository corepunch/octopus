...
<div class="post-card post-card--{{postType}}">
  ...
  {{else if (eq postType "link")}}
    <div class="post-card-body">
      {{#if linkUrl}}
        <a href="{{safeUrl linkUrl}}" class="post-card-title" target="_blank" rel="noopener noreferrer">{{linkUrl}}</a>
      {{else}}
...
{{else if (eq postType "link")}}
  <h1 class="post-page-title">
    {{#if linkUrl}}
      <a href="{{safeUrl linkUrl}}" class="post-page-title-link" target="_blank" rel="noopener noreferrer">{{linkUrl}}</a>
    {{else}}
      Link
    {{/if}}
  </h1>
